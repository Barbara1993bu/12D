...
class ValueDial(QWidget):
    ...
    def paintEvent(self, event):
        ...
        qp.setPen('black')
        menuBar_label_font = QFont()
        menuBar_label_font.setFamily(u"Segoe UI")
        menuBar_label_font.setPointSize(14)
        qp.setFont(menuBar_label_font)
        for p in range(0, fullRange + rangeOffset, self.notchSize()):
            ...
            textRect.setSize(fm.size(Qt.TextSingleLine, str(value))*2)
